...
text
   ...
   function toggleCirclePopup() {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Hide share buttons if not supported (UX improvement)
        if (!navigator.share) {
            const shareLaoBtn = document.getElementById("shareLaoImageButton");
            const shareThaiBtn = document.getElementById("shareThaiImageButton");
            if (shareLaoBtn) shareLaoBtn.style.display = "none";
            if (shareThaiBtn) shareThaiBtn.style.display = "none";
        }
    });
